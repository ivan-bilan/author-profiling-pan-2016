...
class FeatureClass(object):
    ...
    def __init__(self, lang):
        ...
        if lang == "en":
            ...
            ### Change the path to the Resource folder if needed ###

            # self.connective_words_list = self.extract_bow('Resources/en/connective_words.txt')
    ...
    ################# These are all the bag of words features START #################
    ...
    ################# These are all the bag of words features END #################

    # get all emoticons
    def get_emoticons(self, untagged, average_value = 0):

        """
        Wasn't used in the final classification.
        """
